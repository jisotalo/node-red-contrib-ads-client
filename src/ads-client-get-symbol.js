...
module.exports = function (RED) {
  function AdsClientGetSymbol(config) {
    ...
    this.on("input", async (msg, send, done) => {
      ...
      try {
        const res = await this.connection.getClient().getSymbol(variable);
  ...
  RED.nodes.registerType("ads-client-get-symbol", AdsClientGetSymbol);
};
