...
module.exports = function (RED) {
  function AdsClientReadTcSystemExtendedState(config) {
    ...
    this.on("input", async (msg, send, done) => {
      ...
      try {
        const res = await this.connection.getClient().readTcSystemExtendedState();
  ...
  RED.nodes.registerType("ads-client-read-tc-system-extended-state", AdsClientReadTcSystemExtendedState);
};
